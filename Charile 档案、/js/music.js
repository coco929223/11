$(function(){
    ...
    var musicImgsData = ['img/charile36.jpg','img/charile39.jpg','img/charile40.jpg','img/charile41.jpg','img/charile58.jpg']    // 图片地址数组
    var musicNameData = ['大鱼','时结','人是-','花开忘忧','化身孤岛的鲸'];                   // 歌曲名数组
    var artistNameData = ['周深','周深','周深','周深','周深']            // 创作歌手数组
    var musicUrls=['MP3/周深 - 大鱼.flac','MP3/周深 _ 王者荣耀 - 时结.flac','MP3/周深 - 人是_.flac','MP3/周深 - 花开忘忧.flac','MP3/周深 - 化身孤岛的鲸.ogg'];// 歌曲mp3数组
